    ...
    return (
        <div className="max-w-4xl mx-auto space-y-12 animate-in fade-in duration-700 pb-20">
            ...
            <section className="glass-card p-8 rounded-2xl space-y-6 text-gray-800 dark:text-text-primary">
                <h3 className="text-2xl font-bold text-gray-900 dark:text-white border-l-4 border-primary pl-4">1. Génération de Clés Chaotiques</h3>
            ...
            <section className="glass-card p-8 rounded-2xl space-y-6 text-gray-800 dark:text-text-primary">
                <h3 className="text-2xl font-bold text-gray-900 dark:text-white border-l-4 border-accent pl-4">2. Processus de Chiffrement</h3>
            ...
            <section className="glass-card p-8 rounded-2xl space-y-6 text-gray-800 dark:text-text-primary">
                <h3 className="text-2xl font-bold text-gray-900 dark:text-white border-l-4 border-yellow-500 pl-4">3. Processus de Déchiffrement</h3>
                <p className="text-gray-700 dark:text-gray-300">
            ...
            <section className="glass-card p-8 rounded-2xl space-y-6 text-gray-800 dark:text-text-primary">
                <h3 className="text-2xl font-bold text-gray-900 dark:text-white border-l-4 border-success pl-4">4. Analyse de Sécurité</h3>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-center">
                    <div>
                        <div className="text-4xl font-bold text-gray-900 dark:text-white mb-2">2<sup>299</sup></div>
                        <div className="text-sm text-gray-600 dark:text-gray-400 uppercase tracking-widest">Espace Clé</div>
                    </div>
                    <div>
                        <div className="text-4xl font-bold text-gray-900 dark:text-white mb-2">~8.0</div>
                        <div className="text-sm text-gray-600 dark:text-gray-400 uppercase tracking-widest">Entropie (bits)</div>
                    </div>
                    <div>
                        <div className="text-4xl font-bold text-gray-900 dark:text-white mb-2">&gt;99.6%</div>
